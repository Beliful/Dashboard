...
import tractorImage1 from 'src/turktraktor/assets/images/tractor1.png'
import tractorImage2 from 'src/turktraktor/assets/images/tractor2.png'
...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchLatestData = () => {
      ...
      console.log('aliooooooooooooo:', latestData)
                  ...
                  return (
                    <CCol key={tractor.id} sm="6" md="4" lg="3" className="mb-4">
                      <CCard style={{ width: '18rem', position: 'relative' }}>
                        <CCardImage orientation="top" src={tractor.imagePath == "tractor1" ? tractorImage1: tractorImage2} />
                        <CCardBody>
