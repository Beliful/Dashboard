...
import { Agriculture, RssFeed, LocalShipping } from '@mui/icons-material'
import { useNavigate } from 'react-router-dom'
import tractors from 'src/ceooffice/data/tractor'
import iotDevices from 'src/ceooffice/data/iot-devices'
import tractorMeasurements from 'src/ceooffice/util/tractorMeasurements'
import deviceData from 'src/ceooffice/data/devices'
        ...
        {data.map((item) => {
          ...
          return (
            <Marker
              ...
              icon={
                  createCustomIcon(<LocalShipping />, getVehicleColor(currentVehicle.status))
              }
            >
              <Popup>
                {showTractors ? (
                  ...
                  >
                    <h5
                      ...
                      onClick={() => navigate(`/ceooffice/dashboard/vehicle/${currentVehicle.tractorId}`)}
                    >
                  ...
                  >
                    <h5
                      style={{ cursor: 'pointer', textDecoration: 'underline', color: 'black' }}
                      onClick={() => navigate(`/ceooffice/iot-devices/${currentDevice.id}`)}
                    >
                      {currentDevice.name}
                    </h5>
                    <p style={{ fontStyle: 'italic', color: 'gray' }}>
