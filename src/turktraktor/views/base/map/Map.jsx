...
import tractorMeasurements from 'src/turktraktor/util/tractorMeasurements'
import deviceData from 'src/turktraktor/data/devices'
              ...
              <Popup>
                {showTractors ? (
                  ...
                  >
                    <h5
                      style={{ cursor: 'pointer', textDecoration: 'underline', color: 'black' }}
                      onClick={() => navigate(`/turktraktor/iot-devices/${currentDevice.id}`)}
                    >
                      {currentDevice.name}
                    </h5>
                    <p style={{ fontStyle: 'italic', color: 'gray' }}>
